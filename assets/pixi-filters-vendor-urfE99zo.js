import { F as Filter, d as deprecation, G as GpuProgram, a as GlProgram, T as TexturePool, C as Color } from "./pixi.js-vendor-By4Tt1Nl.js";
...
const _KawaseBlurFilter = class _KawaseBlurFilter2 extends Filter {
  ...
  constructor(...args) {
    ...
    const gpuProgram = GpuProgram.from({
      ...
      fragment: {
        source: (options == null ? void 0 : options.clamp) ? sourceClamp : source$1,
        entryPoint: "mainFragment"
      }
    });
    const glProgram = GlProgram.from({
      vertex,
      fragment: (options == null ? void 0 : options.clamp) ? fragmentClamp : fragment$1,
...
const _GlowFilter = class _GlowFilter2 extends Filter {
  ...
  constructor(options) {
    ...
    const distance = (_a = options.distance) != null ? _a : 10;
    ...
    const glProgram = GlProgram.from({
      vertex,
      fragment: fragment.replace(/__ANGLE_STEP_SIZE__/gi, "".concat((1 / quality / distance).toFixed(7))).replace(/__DIST__/gi, "".concat(distance.toFixed(0), ".0")),
      name: "glow-filter"
    });
    super({
      gpuProgram,
...
export {
  GlowFilter as G,
  KawaseBlurFilter as K
};
//# sourceMappingURL=pixi-filters-vendor-urfE99zo.js.map
